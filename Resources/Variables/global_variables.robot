...
&{LBL_SEARCH}           en=Search                 ar=بحث
&{LBL_SEARCH_HINT}      en=Type what you are looking for here    ar=اكتب اللي بتدور عليه هنا
...
&{LBL_VERIFY_ACCOUNT}   en=Verify your account    ar=وثّق حسابك
&{BTN_VERIFY_NOW}       en=Verify now             ar=وثّق الآن
